...
[docs/adr](docs/adr/README.md), девятнадцать принятых Architecture Decision
...
```
docs/adr/              девятнадцать ADR — источник истины по «почему»
...
все девять контрольных вопросов дали верные числа (сверено с SQL). Что найдёт
