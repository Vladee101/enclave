...
| 6 | Гибридный поиск + RRF, цитаты в интерфейсе, стриминг ответа | работает на живой модели; путь запроса проверен повтором вне интерфейса, клик-тест в окне приложения — следующий шаг |
...
фрагментов в секунду, ответ — 0.5–1.1 сек при 67–76 ток/с. Что ещё не
проверено: сквозной сценарий кликами в окне приложения (двое пользователей,
два департамента), LoRA-адаптеры (их пока нет ни одного) и PDF / DOCX —
