...
Источник истины — `enclave/migrations/001–015`. `db/schema.sql` — исходный референсный проект, нигде не применяется и с живой схемой расходится.
...
- ADR-0012, 0013; ~~ADR-0014~~ — решено, прототип проверен; встроить в приложение: запуск и остановка сервера, пароли под DPAPI, скрипт сборки комплекта, CI на PostgreSQL 18
