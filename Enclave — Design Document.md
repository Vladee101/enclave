...
| departments | Департаменты. Видны пользователю, только если он в них член (миграция 005). `is_default` — общий департамент General, в который попадает каждый новый профиль; ровно один (миграция 010, ADR-0016) |
